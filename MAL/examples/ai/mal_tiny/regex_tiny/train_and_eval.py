...
for epoch in range(1, 21):
    ...
    total_loss = 0
    for pair in pairs:
        full = pair['prompt'] + pair['completion']
    ...
    if epoch % 5 == 0:
        print(f"  Epoch {epoch}/20: loss={total_loss/len(pairs):.4f}")
torch.save(model.state_dict(), 'regex_tiny/Regex-Tiny-v1.0.pt')
print("\n🏆 Model saved: regex_tiny/Regex-Tiny-v1.0.pt")
print("\n" + "=" * 70)
